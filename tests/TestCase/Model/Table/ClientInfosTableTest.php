...
/**
 * App\Model\Table\ClientInfosTable Test Case
 */
class ClientInfosTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ClientInfos') ? [] : ['className' => 'App\Model\Table\ClientInfosTable'];
        $this->ClientInfos = TableRegistry::get('ClientInfos', $config);
    }
