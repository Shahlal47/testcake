...
use App\Model\Table\GeofencesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\GeofencesTable Test Case
 */
class GeofencesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Geofences') ? [] : ['className' => 'App\Model\Table\GeofencesTable'];
        $this->Geofences = TableRegistry::get('Geofences', $config);
    }
