...
/**
 * ClientTripPathsFixture
 *
 */
class ClientTripPathsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'trip_path' => ['type' => 'string', 'length' => 400, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'client_info_id' => 1,
            'client_contact_id' => 1,
            'trip_path' => 'Lorem ipsum dolor sit amet',
            'created' => '2015-06-28 04:00:09',
            'modified' => '2015-06-28 04:00:09',
            'active' => 1
        ],
    ];
}
