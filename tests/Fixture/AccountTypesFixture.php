...
class AccountTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'months' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'months' => 1,
            'created' => '2015-06-28 03:53:42',
            'modified' => '2015-06-28 03:53:42'
        ],
    ];
}
