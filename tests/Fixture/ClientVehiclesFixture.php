...
/**
 * ClientVehiclesFixture
 *
 */
class ClientVehiclesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'registrtion_number' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'vehicle_model' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'vehicle_color' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'speed_limit' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'fuel_tank_size' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'fuel_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'vehicle_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'registration_expire_date' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'registrtion_number' => 'Lorem ipsum dolor sit amet',
            'vehicle_model' => 'Lorem ipsum dolor sit amet',
            'vehicle_color' => 'Lorem ipsum dolor ',
            'speed_limit' => 1,
            'fuel_tank_size' => 1,
            'fuel_type_id' => 1,
            'vehicle_type_id' => 1,
            'registration_expire_date' => '2015-06-28',
            'client_info_id' => 1,
            'client_device_id' => 1,
            'created' => '2015-06-28 04:00:46',
            'modified' => '2015-06-28 04:00:46',
            'minimum_mileage' => 1,
