...
/**
 * ClientPublicidsFixture
 *
 */
class ClientPublicidsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'publicid' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'client_info_id' => '',
            'client_device_id' => 1,
            'created' => '2015-06-28 03:59:25',
            'modified' => '2015-06-28 03:59:25'
        ],
    ];
}
